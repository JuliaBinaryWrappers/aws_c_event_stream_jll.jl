# `aws_c_event_stream_jll.jl` (v0.6.0+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/5d1fe9e4e3ca3bbe882884ce3f37dd79b922aeec/A/aws_c_event_stream/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/awslabs/aws-c-event-stream.git (revision: `c741f95e9050a1a4bed4b3aa7543bd3e024f6e56`)
