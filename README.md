# `aws_c_event_stream_jll.jl` (v0.5.9+0)
...
The originating [`build_tarballs.jl`](https://github.com/JuliaPackaging/Yggdrasil/blob/e847cc036586733a914b7a38f3ce489127cec4a3/A/aws_c_event_stream/build_tarballs.jl) script can be found on [`Yggdrasil`](https://github.com/JuliaPackaging/Yggdrasil/), the community build tree.
...
* git repository: https://github.com/awslabs/aws-c-event-stream.git (revision: `f43a3d24a7c1f8b50f709ccb4fdf4c7fd2827fff`)
